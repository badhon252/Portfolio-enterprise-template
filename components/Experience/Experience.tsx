export default function Experience() {
  return (
    <section id="experience" className="flex h-screen flex-col justify-center">
      <h1 className="h1 text-8xl font-black">Experiences</h1>
          ...
          <ul className="my-4">
            ...
            <li className="experience-details my-4">
              <article>
                ...
                passionately teaching a diverse group of students and equipping them with essential skills in Python for
            ...
            <li className="experience-details my-4">
              <article>
                ...
                exceptional student performance and high course completion rates. Received positive feedback for making
            ...
            <li className="experience-details my-4">
              <article>
                ...
                build confidence in their coding abilities and guiding them in their journey towards becoming proficient
                Python developers.
              </article>
            </li>
          </ul>
